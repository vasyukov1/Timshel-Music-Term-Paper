...
//        print("Get \(tracks.count) tracks of [\(login)] for addition to playlist")
    ...
    func editPlaylist(title: String, tracks: [TrackResponse], image: UIImage?, navigationController: UINavigationController) {
        
        var updatedPlaylist = playlist
        let oldTitle = updatedPlaylist.name
...
//        updatedPlaylist.tracks.append(contentsOf: tracks)
        ...
        let playlistVC = PlaylistViewController(viewModel: PlaylistViewModel(playlistResponse: updatedPlaylist))
